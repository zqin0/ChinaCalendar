...
function addDay(v) {
   ...
   if(solar_obj.innerHTML!='') {
      ...
      console.log("获取天干地支 = "+cld[d].c_y+'年 '+cld[d].c_m+'月 '+cld[d].cal_d+"日");
      console.log("获取闰年纪年 = "+"农历"+(cld[d].isLeap?'闰 ':' ')+cld[d].l_m+' 月 '+cld[d].l_d+"日");
      console.log("获取当前所选日 = "+cld[d].s_d);
      console.log("获取节假日与24节气 = "+cld[d].solarTerms + ' ' + cld[d].solar_festival + ' ' + cld[d].lunar_festival);
